app.controller('MallVoucherCounter.IndexCrtl', ['$scope', '$http', 'SweetAlert','toaster', function ($scope, $http, SweetAlert,toaster) {
        ...
        $scope.getData = function () {
            ...
            $http.post('/mall-vouchercounters.json').success(function (d) {
                $scope.vouchercounters = d.mallVouchercounters;
                $scope.pager = d.pager;
        ...
        $scope.changeStatus = function (v, id) {
            var res = $http.post("/mall-vouchercounters/change-status.json", {id: id, status: v});
        ...
        $scope.form = {
            submit: function (form) {
                ...
                if (form.$invalid) {
                    ...
                    $scope.isLoading = true;
                    $http.post("/mall-vouchercounters/add.json", $scope.nwVoucher).success(function (d) {
                        if (d.result.error == 0) {
