...
class AnswersController extends AppController
{
    ...
    public function add()
    {
        ...
        $customers = $this->Answers->Customers->find('list', ['limit' => 200]);
        $questions = $this->Answers->Questions->find('list', ['limit' => 200]);
        $options = $this->Answers->Options->find('list', ['limit' => 200]);
        $this->set(compact('answer', 'customers', 'questions', 'options'));
        $this->set('_serialize', ['answer']);
    }
    ...
    public function delete($id = null)
    {
        ...
        $softDeleted = $this->Answers->updateAll(['soft_deleted' => 1], ['id' => $id]);
        if ($softDeleted) {
